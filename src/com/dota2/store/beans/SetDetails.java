...
public class SetDetails implements Serializable {
	...
	public SetDetails(String int1, String string, double string2, String string3, String string4) {
	...
	public String toString() {
		return "SetDetails [setID=" + setID + ", setName=" + setName + ", setPrice=" + setPrice + ", setQuality="
				+ setQuality + ", setImg=" + setImg + "]";
	}
